...
- There are two kinds of packs on the SourceBox platform. Regular packs and code packs. regular packs are storage boxes for most common files. Code packs are storage boxes for code and code related files.
